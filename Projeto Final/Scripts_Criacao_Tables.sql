...
CREATE TABLE IF NOT EXISTS Morada(
    ...
    INDEX idx_morada_codigo_postal (codigo_postal)
);
...
CREATE TABLE IF NOT EXISTS Utilizador(
	...
	INDEX idx_utilizador_email (email),
	INDEX idx_utilizador_nif (nif)
);

CREATE TABLE IF NOT EXISTS Verificacao_Indentidade(
...
CREATE TABLE IF NOT EXISTS Modalidade_Individual(
...
CREATE TABLE IF NOT EXISTS Jogo_Individual(
	id_jogo_individual INT AUTO_INCREMENT,
	id_modalidade_individual INT NOT NULL,
	nome_jogo VARCHAR(255) NOT NULL,
	data_jogo DATETIME NOT NULL,
    resultado_jogo VARCHAR(255) DEFAULT 'A Determinar',
	...
	INDEX idx_jogo_individual_data (data_jogo),
    INDEX idx_jogo_individual_nome (nome_jogo)
);
...
CREATE TABLE IF NOT EXISTS Jogador(
    ...
    INDEX idx_jogador_nome (nome, apelido)
);

CREATE TABLE IF NOT EXISTS Jogador_JogoIndividual(
...
CREATE TABLE IF NOT EXISTS Equipa (
	...
	INDEX idx_equipa_nome (nome_equipa)
);

CREATE TABLE IF NOT EXISTS Jogador_Equipa(
	id_jogador INT,
	id_equipa INT,
...
CREATE TABLE IF NOT EXISTS Modalidade_Coletiva(
...
CREATE TABLE IF NOT EXISTS Jogo_Coletivo (
    ...
    INDEX idx_jogo_coletivo_data (data_jogo),
    INDEX idx_jogo_coletivo_nome (nome_jogo)
);

CREATE TABLE IF NOT EXISTS JogoColetivo_Equipa(
...
CREATE TABLE IF NOT EXISTS Tipo_Aposta(
...
CREATE TABLE IF NOT EXISTS Aposta_JogoIndividual(
...
CREATE TABLE IF NOT EXISTS Aposta_Jogador(
	id_tipo_aposta INT NOT NULL,
	id_jogador INT NOT NULL,
	id_equipa INT NOT NULL,
	detalhe_aposta VARCHAR(255),
...
CREATE TABLE IF NOT EXISTS Aposta_JogoColetivo(
...
CREATE TABLE IF NOT EXISTS Tipo_Aposta_Boletim(
...
CREATE TABLE IF NOT EXISTS Boletim(
	...
	INDEX idx_boletim_resultado (resultado_boletim)
);

CREATE TABLE IF NOT EXISTS ApostaJogoIndividual_Boletim(
...
CREATE TABLE IF NOT EXISTS ApostaJogoColetivo_Boletim(
	id_boletim INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS ApostaJogador_Boletim(
	id_boletim INT NOT NULL,
	id_equipa INT NOT NULL,
	id_jogador INT NOT NULL,
...
CREATE USER 'AdminSistema'@'localhost' IDENTIFIED BY 'AdminStrongPassword';
GRANT ALL PRIVILEGES ON BetPrime.* TO 'AdminSistema'@'localhost' WITH GRANT OPTION;

-- Gestor dos Eventos desportivos ---
CREATE USER IF NOT EXISTS 'GestorEventos'@'%' IDENTIFIED BY 'GestorEventosPassword';
GRANT SELECT, INSERT, UPDATE ON BetPrime.Jogo_Individual TO 'GestorEventos'@'%' WITH GRANT OPTION;
GRANT SELECT, INSERT, UPDATE ON BetPrime.Jogador_JogoIndividual TO 'GestorEventos'@'%' WITH GRANT OPTION;
GRANT SELECT, INSERT, UPDATE ON BetPrime.Jogo_Coletivo TO 'GestorEventos'@'%' WITH GRANT OPTION;
GRANT SELECT, INSERT, UPDATE ON BetPrime.JogoColetivo_Equipa TO 'GestorEventos'@'%' WITH GRANT OPTION;

-- Gestor das apostas desportivas ---
CREATE USER IF NOT EXISTS 'GestorApostas'@'%' IDENTIFIED BY 'GestorApostasPassword';
GRANT SELECT, INSERT, UPDATE ON BetPrime.Aposta_Jogador TO 'GestorApostas'@'%' WITH GRANT OPTION;
GRANT SELECT, INSERT, UPDATE ON BetPrime.Aposta_JogoColetivo TO 'GestorApostas'@'%' WITH GRANT OPTION;
GRANT SELECT, INSERT, UPDATE ON BetPrime.Aposta_JogoIndividual TO 'GestorApostas'@'%' WITH GRANT OPTION;
GRANT SELECT, INSERT, UPDATE ON BetPrime.Boletim TO 'GestorApostas'@'%' WITH GRANT OPTION;

-- Gestor Apoio Utilizadores ---
CREATE USER IF NOT EXISTS 'GestorUtilizador'@'%' IDENTIFIED BY 'GestorUtilizadorPassword';
GRANT SELECT, INSERT, UPDATE ON BetPrime.Morada TO 'GestorUtilizador'@'%' WITH GRANT OPTION;
GRANT SELECT, INSERT, UPDATE ON BetPrime.Utilizador TO 'GestorUtilizador'@'%' WITH GRANT OPTION;
GRANT SELECT, INSERT, UPDATE ON BetPrime.Verificacao_Indentidade TO 'GestorUtilizador'@'%' WITH GRANT OPTION;
...
##### Criar jogos Snooker #####
INSERT INTO Jogo_Individual (id_modalidade_individual, nome_jogo, data_jogo)
VALUES 
...
INSERT INTO Jogo_Coletivo (id_modalidade_coletiva, nome_jogo, resultado_jogo, data_jogo)
VALUES
-- Inserir Jogos de Futebol
(1, 'FC Porto vs SL Benfica', '2-1', '2023-10-01 20:30:00'),  -- Futebol
(1, 'Sporting CP vs SC Braga', '0-0', '2023-10-02 18:00:00'),
(1, 'Vitória SC vs Rio Ave FC', '1-1', '2023-10-03 17:00:00'),

-- Inserir Jogos de Futsal
(2, 'Sporting CP Futsal vs SL Benfica Futsal', '3-2', '2023-10-04 19:00:00'),  -- Futsal
(2, 'SC Braga Futsal vs Modicus Sandim', '1-1', '2023-10-05 16:00:00'),
(2, 'Leões de Porto Salvo vs AD Fundão', '4-3', '2023-10-06 18:30:00'),

-- Inserir Jogos de Voleibol
(3, 'Sporting CP Voleibol vs SL Benfica Voleibol', '3-1', '2023-10-07 15:00:00'),  -- Voleibol
(3, 'AJF Bastardo vs SC Espinho', '2-3', '2023-10-08 14:00:00'),
(3, 'VC Viana vs Leixões SC Voleibol', '3-0', '2023-10-09 17:30:00');
...
SET data_jogo = '2024-06-01 16:00:00'
...
-- Apagar dados de relação entre apostas e boletins
DELETE FROM ApostaJogoIndividual_Boletim;
DELETE FROM ApostaJogoColetivo_Boletim;
DELETE FROM ApostaJogador_Boletim;

-- Apagar dados de apostas
DELETE FROM Aposta_JogoIndividual;
DELETE FROM Aposta_JogoColetivo;
DELETE FROM Aposta_Jogador;

-- Apagar dados dos tipos de aposta
DELETE FROM Tipo_Aposta;

-- Apagar dados dos boletins
DELETE FROM Boletim;
DELETE FROM Tipo_Aposta_Boletim;

-- Apagar dados de equipas e jogos coletivos
DELETE FROM JogoColetivo_Equipa;
DELETE FROM Jogo_Coletivo;
DELETE FROM Modalidade_Coletiva;

-- Apagar dados de jogadores e jogos individuais
DELETE FROM Jogador_JogoIndividual;
DELETE FROM Jogo_Individual;
DELETE FROM Jogador_Equipa;
DELETE FROM Equipa;

-- Apagar dados de jogadores e modalidades individuais
DELETE FROM Jogador;
DELETE FROM Modalidade_Individual;

-- Apagar dados de verificações de identidade e utilizadores
DELETE FROM Verificacao_Indentidade;
DELETE FROM Utilizador;

-- Apagar dados de moradas
DELETE FROM Morada;

-- Apagar dados dos tipos de aposta
DELETE FROM Tipo_Aposta;

-- Apagar tabelas de relação entre apostas e boletins
DROP TABLE IF EXISTS ApostaJogoIndividual_Boletim;
DROP TABLE IF EXISTS ApostaJogoColetivo_Boletim;
DROP TABLE IF EXISTS ApostaJogador_Boletim;

-- Apagar tabelas de apostas
DROP TABLE IF EXISTS Aposta_JogoIndividual;
DROP TABLE IF EXISTS Aposta_JogoColetivo;
DROP TABLE IF EXISTS Aposta_Jogador;

-- Apagar tipos de aposta
DROP TABLE IF EXISTS Tipo_Aposta;

-- Apagar boletins
DROP TABLE IF EXISTS Boletim;
DROP TABLE IF EXISTS Tipo_Aposta_Boletim;

-- Apagar tabelas de equipas e jogos coletivos
DROP TABLE IF EXISTS JogoColetivo_Equipa;
DROP TABLE IF EXISTS Jogo_Coletivo;
DROP TABLE IF EXISTS Modalidade_Coletiva;

-- Apagar tabelas de jogadores e jogos individuais
DROP TABLE IF EXISTS Jogador_JogoIndividual;
DROP TABLE IF EXISTS Jogo_Individual;
DROP TABLE IF EXISTS Jogador_Equipa;
DROP TABLE IF EXISTS Equipa;

-- Apagar jogadores e modalidades individuais
DROP TABLE IF EXISTS Jogador;
DROP TABLE IF EXISTS Modalidade_Individual;

-- Apagar verificações de identidade e utilizadores
DROP TABLE IF EXISTS Verificacao_Indentidade;
...
-- Apagar Utilizadores --
REVOKE ALL PRIVILEGES, GRANT OPTION FROM 'AdminSistema'@'localhost';
FLUSH PRIVILEGES;
DROP USER 'AdminSistema'@'localhost';

REVOKE SELECT,INSERT,UPDATE ON BetPrime.Jogo_Individual FROM 'GestorEventos'@'%';
REVOKE SELECT,INSERT,UPDATE ON BetPrime.Jogador_JogoIndividual FROM 'GestorEventos'@'%';
REVOKE SELECT,INSERT,UPDATE ON BetPrime.Jogo_Coletivo FROM 'GestorEventos'@'%';
REVOKE SELECT,INSERT,UPDATE ON BetPrime.JogoColetivo_Equipa FROM 'GestorEventos'@'%';
FLUSH PRIVILEGES;
DROP USER 'GestorEventos'@'%';

REVOKE SELECT,INSERT,UPDATE ON BetPrime.Aposta_Jogador FROM 'GestorApostas'@'%';
REVOKE SELECT,INSERT,UPDATE ON BetPrime.Aposta_JogoColetivo FROM 'GestorApostas'@'%';
REVOKE SELECT,INSERT,UPDATE ON BetPrime.Aposta_JogoIndividual FROM 'GestorApostas'@'%';
REVOKE SELECT,INSERT,UPDATE ON BetPrime.Boletim FROM 'GestorApostas'@'%';
FLUSH PRIVILEGES;
DROP USER 'GestorApostas'@'%';

REVOKE SELECT,INSERT,UPDATE ON BetPrime.Morada FROM 'GestorUtilizador'@'%';
REVOKE SELECT,INSERT,UPDATE ON BetPrime.Utilizador FROM 'GestorUtilizador'@'%';
REVOKE SELECT,INSERT,UPDATE ON BetPrime.Verificacao_Indentidade FROM 'GestorUtilizador'@'%';
FLUSH PRIVILEGES;
DROP USER 'GestorUtilizador'@'%';

DROP DATABASE IF EXISTS BetPrime;